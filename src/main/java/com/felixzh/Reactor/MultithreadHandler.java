...
/**
 * 多线程基本处理器，I/O 的读写由 com.felixzh.Reactor 线程处理，业务的处理交给线程池
 * 
 * @see Reactor
 * @see BasicHandler
 * @author tongwu.net
...
public class MultithreadHandler extends BasicHandler {
	...
	private void processAndHandOff() {
		synchronized (lock) {
			...
			// 最后的发送还是交给 com.felixzh.Reactor 线程处理
			state = SENDING;
			sk.interestOps(SelectionKey.OP_WRITE);
			
			// 这里需要唤醒 Selector，因为当把处理交给 workpool 时，com.felixzh.Reactor 线程已经阻塞在 select() 方法了， 注意
